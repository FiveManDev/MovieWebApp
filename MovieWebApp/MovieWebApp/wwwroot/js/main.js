$(document).ready(function () {
  ...
  function initializeFirstSlider() {
    if ($("#filter__years").length) {
      ...
      var firstValues = [
        document.getElementById("catalogFilterDTO_releaseTimeMin"),
        document.getElementById("catalogFilterDTO_releaseTimeMax"),
      ];
  ...
  function initializeSecondSlider() {
    if ($("#filter__imbd").length) {
      ...
      var secondValues = [
        document.getElementById("catalogFilterDTO_ratingMin"),
        document.getElementById("catalogFilterDTO_ratingMax"),
      ];
  ...
  function initializeThirdSlider() {
    if ($("#slider__rating").length) {
      ...
      var thirdValue = document.getElementById("rating");

      thirdSlider.noUiSlider.on("update", function (values, handle) {
        thirdValue.value = values[handle];
      });
    } else {
      return false;
    }
