...
function AddReview(review) {
  var html = `
    ...
    <div class="reviews__autor">
        ...
        <span class="reviews__time">${ConvertDateTimeToJs(
          review.reviewTime
        )} by ${review.firstName} ${review.lastName}</span>
...
function EditReview(review) {
  ...
  parent.querySelector(".reviews__time").innerHTML =
    ConvertDateTimeToJs(review.reviewTime) +
    " by " +
    review.firstName +
    " " +
    review.lastName;
...
<div id=${"delCata" + review.reviewID} class="zoom-anim-dialog mfp-hide modal">
    ...
    <p class="modal__text">Are you sure to permanently delete "${
      review.title
    }"?</p>
